...
AI Chat Exporter is an open-source, local-first browser extension for exporting chat records from major AI websites. The first milestone focuses on a stable MVP for exporting the current ChatGPT conversation.
